  ...
  <div ref={mainRef} className='relative'>
      ...
      <div ref={page5Ref} className='h-screen w-screen pt-20 bg-[#f1f1f1] flex items-center justify-center relative'>
        ...
        <div className='flex space-x-10  h-[50vh] w-[70vw] ml-[-20rem] mt-21 '>
            ...
            <a href="https://mercedea-clone.netlify.app/" target="_blank" rel="noopener noreferrer" className=' mt-[37vh] ml-[-40vw] h-[250px] w-[350px] hover:scale-110 transition-transform duration-200 tooltip' data-tooltip="Mercedes-Benz Clone"><img className="rounded-md" src={mercedes} alt="mercedes benz clone" /></a>
          </div>
